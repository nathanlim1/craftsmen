...
> *"Build a small oak cabin"* → agentic system generates a block plan → saved as a `.schem` schematic → Baritone pathfinds, scaffolds, and places every block from your inventory.
